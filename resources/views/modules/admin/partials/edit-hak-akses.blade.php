        ...
        <div class="card">
            <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
                ...
                <form action="{{ route('pengaturan.akses.edit-permission') }}" method="GET"
                    ...
                    @csrf
                    <label for="role_id" class="me-2 mb-0 fw-semibold text-nowrap">Pilih Peran:</label>
                    <select name="role_id" id="role_id" class="form-select w-auto" onchange="this.form.submit()">
            ...
            <div class="card-body">
                @if (!isset($selectedRole))
                    <div class="text-center">
                        ...
                        <p class="empty-title">Peran belum dipilih</p>
                        <p class="empty-subtitle text-secondary">Silahkan memilih peran yang ingin diubah Hak Aksesnya
                            pada
                            menu dropdown diatas.</p>
                        </p>
